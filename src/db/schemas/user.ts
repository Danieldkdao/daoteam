...
export const onboardingPhaseEnum = pgEnum(
  "onboarding-phases",
  onboardingPhases,
);

export const pricingPlans = ["free", "pro", "enterprise"] as const;
export type PricingPlan = (typeof pricingPlans)[number];
export const pricingPlanEnum = pgEnum("pricing-plans", pricingPlans);
...
export const organization = pgTable(
  "organization",
  {
    ...
    aiThreadSummaries: integer("ai_thread_summaries").default(0).notNull(),
    aiMessages: integer("ai_messages").default(0).notNull(),
    lastResetOn: timestamp("last_reset_on").defaultNow().notNull(),
    stripeCustomerId: text("stripe_customer_id"),
  },
