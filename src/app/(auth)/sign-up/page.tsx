    ...
    await authClient.signUp.email(
      ...
      },
      {
        ...
        onError: (error) => {
          toast.error(
            error.error.message ||
              "Something went wrong. Failed to create account.",
          );
        },
      },
    );
  ...
  return (
    <div className="w-full max-w-100 space-y-4">
      <div className="w-full rounded-md bg-primary p-4 space-y-2">
        ...
        <span className="text-background">Sign up to get started</span>
      </div>
      <form
      ...
      >
        ...
        <Button className="w-full" disabled={isPending}>
          <LoadingSwap isLoading={isPending}>Sign up</LoadingSwap>
        </Button>
      </form>
